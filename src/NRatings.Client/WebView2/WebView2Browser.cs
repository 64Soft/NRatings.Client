...
{
    class WebView2Browser : IBrowser
    {
        ...
        public WebView2Browser(Func<Form> formFactory)
        {
        ...
        public WebView2Browser(string title = "Authenticating...", int width = 1024, int height = 768)
            : this(() => new Form
            {
